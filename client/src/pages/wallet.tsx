        ...
        <div className="flex-1 bg-white mt-3 mx-4 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-gray-100">
            ...
            {form.formState.errors.accountName && (
              <p className="text-xs text-[#003366] mt-1">{form.formState.errors.accountName.message}</p>
            )}
          </div>
          ...
          <div className="px-5 py-4">
            ...
            {form.formState.errors.accountNumber && (
              <p className="text-xs text-[#003366] mt-1">{form.formState.errors.accountNumber.message}</p>
            )}
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          wallets.map((wallet) => (
            <div
              ...
              } ${wallet.isDefault ? "border-l-4 border-[#003366]" : ""}`}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {wallet.isDefault && (
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <span className="text-xs text-[#003366] font-medium">Par défaut</span>
                  </div>
                )}
              </div>
              ...
              {!selectMode && (
                <div className="flex items-center gap-1">
                  ...
                  >
                    <Trash2 className="w-4 h-4 text-[#003366]" />
                  </button>
                </div>
              )}
